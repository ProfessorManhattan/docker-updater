...
> </br><h3 align="center">**A general-purpose, compact Dockerfile project that includes bash, curl, git, jq, and Node.js in a single container (only 32.1585 MB compressed!)**</h3></br>
